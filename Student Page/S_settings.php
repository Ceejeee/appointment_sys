  ...
  <div style="padding-left: 0px;" id="main" class="w3-container w3-grey">
    <div>
      <div class="w3-container w3-white" style="background: white;">
        ...
        <a href="#" class="split">
        <div class="dropdown">
          <button  onclick="myFunction()" class="dropbtn"><img src="../images/Student_profile.png" width="35" height="35"></button>
      ...
      <div style="padding-left: 30px;">
        <h2> Settings </h2>
         <div class="w3-container w3-white" style="background: white; padding-left:10px; padding-top: 10px;">
          ...
          <div style="text-align: left;"><input type="submit" value="Update Password"><br></div>

            <p><b>Email Notifications</b></p>
            <p>Notify me when appointment is:</p>
                    
            <p>
              <d style="background-color: #a09e9e; padding: 3px 5px 5px 5px;">Accepted <d style="padding-left: 8em;">
              <label class="switch">
              <input type="checkbox">
            ...
            <p><d style="background-color: #a09e9e;padding: 3px 5px 5px 5px;">Declined  <d style="padding-left: 8.3em;">
              <label class="switch">
              <input type="checkbox">
              <span class="slider round"></span>
              </label></d></d>
            ...
            <p><d style="background-color: #a09e9e; padding: 3px 5px 5px 5px;">Rescheduled  <d style="padding-left: 6.4em;">
              <label class="switch">
              <input type="checkbox">
              <span class="slider round"></span>
              </label></d></d>
            ...
            <div style="text-align: left;"><input type="submit" value="Save"><br></div><br>
            <div style="text-align: left;"><a href="Logout.php"><input type="submit" value="Log Out"></a><br></div><br>
