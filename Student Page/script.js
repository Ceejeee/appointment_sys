...
$("#days td.active").on("click", function () {
    ...
    if ($("#instructor").val() == null || $("#instructor").val() == '') {
        $("#instructor").focus();
    } else {
        $("#submit").focus();
    }
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                $("#appointment_list > tbody").append(
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">${element.instructor}</td>
    ...
    if (data[0] !== null) {
        for (let i = 0; i < data.length; i++) {
            ...
            if (element.id == id) {
                ...
                $("#instructor").val(element.instructor);
