                ...
                $("#appointment_list > tbody").append(
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            <button class="btn btn-primary btn-sm " onclick="approve_appointment(${element.id})"><i class="fas fa-calendar-check"></i></button>
                            <button class="btn btn-primary btn-sm " onclick="edit_appointment(${element.id})"><i class="fas fa-calendar-minus"></i></button>
                            <button class="btn btn-danger btn-sm " onclick="delete_appointment(${element.id})"><i class="fas fa-calendar-times"></i></button>
                        </td>
                    </tr>
                    `
                );
    ...
    if (data[0] !== null) {
        for (let i = 0; i < data.length; i++) {
            ...
            if (element.id == id) {
                ...
                $("#submit").prop('disabled', false);
                resechule_appointment(id);
                    }
        }
    }
};

function resechule_appointment(id){
    var data = localStorage.getItem("tbAppointment");
    data = JSON.parse(data);
    if (data[0] !== null) {
        for (let i = 0; i < data.length; i++) {
